...
def main():
    ...
    for img in tqdm(image_paths):
        ...
        process_image(output, img, copy_txt, "snowy", snowy_images, image_type, time_path)
        rainy_images= am.add_rain(image, rain_type='heavy', slant=20)
        process_image(output, img, copy_txt, "rainy", rainy_images, image_type, time_path)
        process_image(output, img, False, "bright", bright_image, image_type, time_path)
        process_image(output, img, False, "dark", dark_image, image_type, time_path)
        process_image(output, img, False, "shadowy", shadowy_images, image_type, time_path)
        process_image(output, img, False, "speedy", speedy_images, image_type, time_path)
